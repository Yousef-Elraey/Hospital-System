...
public class BillingController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UpdateBillingResponse> updateBilling(@PathVariable Long id, @Valid @RequestBody UpdateBillingRequest billingRequest) {


            return new ResponseEntity<>(billingService.updateBilling(id, billingRequest), HttpStatus.OK);
    }
