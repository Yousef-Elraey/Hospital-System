...
public class MedicalRecordController {
   ...
   private final MedicalRecordService medicalRecordService;
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UpdateMedicalRecordResponse> updateMedicalRecordData(@PathVariable Long id, @Valid @RequestBody UpdateMedicalRecordRequest medicalRecordRequest) {


            return new ResponseEntity<>(medicalRecordService.updateMedicalRecordData(id,medicalRecordRequest), HttpStatus.NO_CONTENT);
